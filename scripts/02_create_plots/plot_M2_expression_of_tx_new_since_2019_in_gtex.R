...
ggsave('../../figures/M2_new_tx_since_2019_in_GTEx/M2_new_since_2019_in_gtex_cpm_thresholds.pdf', width=58, height=58, units='mm')
...
ggsave('../../figures/M2_new_tx_since_2019_in_GTEx/M2_new_since_2019_in_gtex_cpm_thresholds_pc_bar.pdf', width=58, height=58, units='mm')
...
ggsave('../../figures/M2_new_tx_since_2019_in_GTEx/M2_new_since_2019_in_gtex_density_plot.pdf', width=58, height=58, units='mm')
...
#	theme(axis.text.x = element_text(angle = 45, hjust=1)) +
	theme(legend.position = 'none',
	      text = element_text(size=5)) +
	ylab("Number of new isoforms since 2019")
ggsave('../../figures/M2_new_tx_since_2019_in_GTEx/M2_new_since_2019_in_gtex_by_category.pdf', width=118, height=58, units='mm')
...
ggplot(perc_expr_df, aes(x=Tissue, y=rel_abund, fill=Tissue)) +
	...
	facet_wrap(~Category) 
#	ggtitle(cat)
ggsave('../../figures/M2_new_tx_since_2019_in_GTEx/M2_new_since_2019_in_gtex_relative_abundance.pdf', width=11, height=8.5, units='in')

pdf('../../figures/M2_new_tx_since_2019_in_GTEx/M2_new_since_2019_in_gtex_relative_abundance_by_category.pdf', width=58/25.4, height=58/25.4)
for (cat in bar_cat) {
...
pdf('../../figures/M2_new_tx_since_2019_in_GTEx/M2_new_since_2019_in_gtex_relative_abundance_poster_children.pdf', width=58/25.4, height=58/25.4)
